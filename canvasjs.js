...
(function() {
    ...
    function za(a, d) { return a - d }

    function Ja(a, d) { return a.x - d.x }
    ...
    function x(a) { return null === a || "undefined" === typeof a }

    function ra(a) { a.indexOf || (a.indexOf = Ra); return a }
    ...
    function L(a, d, b) { return a in d ? d[a] : b[a] }
    ...
    function ua() { for (var a = null, d = 0; d < arguments.length; d++) a = arguments[d], a.style && (a.style.display = "inline") }
    ...
    function na(a, d) {
        ...
        if (x(this.options.margin) && a.options.subtitles)
            for (var b = a.options.subtitles, c = 0; c < b.length; c++)
                if ((x(b[c].horizontalAlign) && "center" === this.horizontalAlign || b[c].horizontalAlign === this.horizontalAlign) && (x(b[c].verticalAlign) && "top" === this.verticalAlign || b[c].verticalAlign === this.verticalAlign) && !b[c].dockInsidePlotArea === !this.dockInsidePlotArea) { this.margin = 0; break }
        ...
        ca = function(a, d, b) {
            ...
            for (var u = 0; k && u < k.length; u++)
                if (d = k[u], "." === d && 0 > l) l = u;
                    ...
                    if ("%" === d) h *= 100;
                    else if ("\u2030" === d) { h *= 1E3; continue } else if ("," === d[0] && "." === d[d.length - 1]) {
            ...
            for (q = k = u = e = l = 0; 0 < m.length;)
                ...
                (b = g + b)) : b = 1 < d.length && ('"' === d[0] && '"' === d[d.length - 1] || "'" === d[0] && "'" === d[d.length - 1]) ? d.slice(1, d.length - 1) + b : d + b : (d = 0 > s ? d.replace("+", "").replace("-", "") : d.replace("-", ""), b += d.replace(/[0]+/, function(a) { return O(s, a.length) }));
            g = "";
            for (m = !1; 0 < n.length;) d = n.shift(), "#" === d || "0" === d ? 0 < a.length && 0 !== Number(a.join("")) ? (g += a.shift(), m = !0) : "0" === d && (g += "0", m = !0) : 1 < d.length && ('"' === d[0] && '"' === d[d.length - 1] || "'" === d[0] && "'" === d[d.length - 1]) ? g += d.slice(1, d.length - 1) : "E" !== d[0] && "e" !== d[0] || "0" !== d[d.length -
                1] || !/[eE][+-]*[0]+/.test(d) ? g += d : (d = 0 > s ? d.replace("+", "").replace("-", "") : d.replace("-", ""), g += d.replace(/[0]+/, function(a) { return O(s, a.length) }));
            b += (m ? f : "") + g;
            return c ? "-" + b : b
        },
        ya = function(a) {
    ...
    M.prototype.isBeingTracked = function(a) { this.options._oldOptions || (this.options._oldOptions = {}); return this.options._oldOptions[a] ? !0 : !1 };
    ...
    M.prototype.removeEventListener = function(a, d) {
        if (a && d && this._eventListeners[a])
            for (var b = this._eventListeners[a], c = 0; c < b.length; c++)
                if (b[c].eventHandler === d) { b[c].splice(c, 1); break }
    };
                    ...
                    if (!(c < u) || p) {
                        ...
                        if (b.viewPortMin === c && f)
                            for (y = 0; y < f.length; y++)
                                if (null === f[y] && r < c) { b.viewPortMin = r; break }
    ...
    A.prototype.getDataPointAtXY = function(a, d, b) {
        ...
        for (b = 0; b < c.length; b++)
            if ("line" === c[b].dataSeries.type || "stepLine" === c[b].dataSeries.type || "area" === c[b].dataSeries.type || "stepArea" === c[b].dataSeries.type)
                if (f =
                    L("markerSize", c[b].dataPoint, c[b].dataSeries) || 8, c[b].distance <= f / 2) { d = !0; break }
    ...
    A.prototype.getAutoFontSize = function(a, d, b) { a /= 400; return Math.max(10, Math.round(Math.min(this.width, this.height) * a)) };
    ...
    A.prototype._plotAreaMouseMove = function(a, d) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!f || 2 < Math.abs(b) || !g || 2 < Math.abs(c)) && (this.panEnabled || this.zoomEnabled))
                ...
                }, clearTimeout(h._panTimerId), h._panTimerId = setTimeout(function(b, c, e, f) { return function() { h._zoomPanToSelectedRegion(b, c, e, f, !0) && (h._dispatchRangeEvent("rangeChanging", "pan"), h.render(), h._dispatchRangeEvent("rangeChanged", "pan"), h.dragStartPoint.x = a, h.dragStartPoint.y = d) } }(f.x1, f.y1, f.x2, f.y2), 0);
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            ...
            if (null !== t && "" !== t) {
                ...
                m.dataSeries.indexLabelMaxWidth =
                    r.maxWidth;
                if (0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("bubble") || 0 <= n.indexOf("scatter")) { if (m.dataPoint.x < Z.viewportMinimum || m.dataPoint.x > Z.viewportMaximum || m.dataPoint.y < ja.viewportMinimum || m.dataPoint.y > ja.viewportMaximum) continue } else if (0 <= n.indexOf("column")) { if (m.dataPoint.x < Z.viewportMinimum || m.dataPoint.x > Z.viewportMaximum || m.bounds.y1 > b.y2 || m.bounds.y2 < b.y1) continue } else if (0 <= n.indexOf("bar")) {
                        ...
                        if (u = l[s].x.getTime ? l[s].x.getTime() : l[s].x, !(u < a.axisX.dataInfo.viewPortMin ||
                            ...
                            if ("number" !== typeof l[s].y) 0 < s && !(k.connectNullData || y || q) && (d.stroke(), v && b.stroke()), y = !0;
                                ...
                                if (0 < l[s].markerSize || 0 < k.markerSize) {
                                    ...
                                    c.push(D);
                                    t = G(t);
                                    v && c.push({ x: u, y: w, ctx: b, type: D.type, size: D.size, color: t, borderColor: t, borderThickness: D.borderThickness })
                        ...
                        if (u = m[s].getTime ? m[s].x.getTime() : m[s].x, !(u < a.axisX.dataInfo.viewPortMin ||
                            ...
                            if ("number" !== typeof m[s].y) 0 < s && !w && (l.connectNullData ? b.setLineDash && (0 < y.length && (l.options.nullDataLineDashType || !m[s - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = p, n = l.nullDataLineDashType) : (d(y), y = [])), w = !0;
                                ...
                                if (0 < m[s].markerSize || 0 < l.markerSize) {
                                    ...
                                    f.push(D);
                                    t = G(t);
                                    v && f.push({ x: u, y: w, ctx: c, type: D.type, size: D.size, color: t, borderColor: t, borderThickness: D.borderThickness })
                                }(m[s].indexLabel ||
                            ...
                            if (r = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !q)))
                                if ("number" !== typeof p[e].y) 0 < e && !q && (n.connectNullData ? b.setLineDash && (0 < y.length && (n.options.nullDataLineDashType || !p[e - 1].lineDashType)) && (y[y.length - 1].newLineDashArray =
                                    ...
                                    if (0 !== p[e].markerSize && (0 < p[e].markerSize || 0 < n.markerSize)) {
                                        ...
                                        h.push(J);
                                        R = G(R);
                                        v && h.push({ x: r, y: q, ctx: c, type: J.type, size: J.size, color: R, borderColor: R, borderThickness: J.borderThickness })
    ...
    A.prototype.renderPie = function(a) {
        ...
        function f(a) {
            for (var b = null, d = 1; d < n.length; d++)
                if (b = (a + d + r.length) % r.length, r[b].hemisphere !== r[a].hemisphere) { b = null; break } else if (r[b].indexLabelText && b !== a && (0 > c(r[b], r[a]) || ("right" === r[a].hemisphere ? r[b].indexLabelTextBlock.y >= r[a].indexLabelTextBlock.y :
        ...
        function g(a, b, d) {
            ...
            if (0 <= a && a < n.length) {
                ...
                for (l = 1; l < n.length; l++)
                    if (k = (a - l + r.length) % r.length, r[k].hemisphere !== r[a].hemisphere) { k = null; break } else if (r[k].indexLabelText && r[k].hemisphere === r[a].hemisphere && k !== a && (0 > c(r[k], r[a]) || ("right" === r[a].hemisphere ? r[k].indexLabelTextBlock.y <= r[a].indexLabelTextBlock.y : r[k].indexLabelTextBlock.y >= r[a].indexLabelTextBlock.y))) break;
                else k = null;
                p = k;
                m = f(a);
                l = k = 0;
    ...
    B.prototype.getPixelCoordinatesOnAxis = function(a) { var d = {}; if ("bottom" === this._position || "top" === this._position) d.x = this.convertValueToPixel(a), d.y = this.lineCoordinates.y1; if ("left" === this._position || "right" === this._position) d.y = this.convertValueToPixel(a), d.x = this.lineCoordinates.x2; return d };
    ...
    S.prototype.getToolTipInnerHTML = function(a) {
        ...
        for (var h = !0, k = 0; k < d.length; k++)
            if (d[k].dataSeries.toolTipContent || d[k].dataPoint.toolTipContent) { h = !1; break }
    ...
    ma.prototype.getNewObjectTrackingId = function() { return ++this.lastObjectId };
        ...
        if ("mousemove" === a.type || "click" === a.type) {
            ...
            for (b = 0; b < d.length; b++) {
                ...
                for (c = 0; c < this.mouseoveredObjectMaps.length; c++)
                    if (d[b].id === this.mouseoveredObjectMaps[c].id) { f = !0; break }
    ...
    var F = {
            ...
            easing: {
                ...
                easeInQuart: function(a, d, b, c) { return b * (a /= c) * a * a * a + d }
            }
        },
        P = {
        ...
        ka = {
            ...
            formatNumber: function(a, d, b) { b = b || "en"; if (qa[b]) return ca(a, d || "#,##0.##", new pa(b)); throw "Unknown Culture Name"; },
